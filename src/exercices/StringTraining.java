public class StringTraining {
    ...
    public static String replaceChar(String string, char search, char replace) {
        /*Utiliser pour créer une classe mutable: construction d'une string 
        avec la possibilité de la modifier sans créer une nouvelle instance de la chaîne à chaque modification apportées.*/
    ...
    public static String[] split(String string, String delimiter) {
        ...
        String replacedString = string.replace(delimiter, ",");
